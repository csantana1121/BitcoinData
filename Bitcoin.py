...
# Test 2: Check that parseJson function has worked and return a list of 4 values in order
# Test 3: Check that sql database bitcoin exists 
# Test 4: Check that table Price_Index in bitcoin is made and not empty
# Test 5: Check that Price_Index table is not overwritten and adds new value each call
def addtoPriceIndex():
